...
mutation searchPublication($userType:String, $carState: String, $state: String, $MAHtoken: String, $page: Int, $order: String)
  {searchPublication(userType: $userType, carState: $carState, state: $state, MAHtoken:$MAHtoken, page:$page, order:$order) {
    hasNextPage
    totalCount    
    Publications {
      CurrentState {
