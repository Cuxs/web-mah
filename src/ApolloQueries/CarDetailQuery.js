...
query CommentThread($publication_id: Int!, $MAHtoken: String, $chatToken: String) {
  CommentThread(publication_id: $publication_id, MAHtoken: $MAHtoken, chatToken: $chatToken) {
    id
    chatToken
    messages {
      id
