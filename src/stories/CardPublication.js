    ...
    <div className="row item-car wide">
      ...
      <div className="col-8">
        <div className="item-data">
          <p className="item-state badge badge-secondary published">
            {stateName}
          </p>
        ...
        <div className="item-admin">
          {stateName !== 'Vendida' && (
            <Button className="btn-default btn-link-primary float-left">
              Marcar como Vendido
            </Button>
          )}
          ...
          {isPubVisible(stateName) &&
            stateName !== 'Destacada' && stateName !== 'Vendida' &&
            (<Button
              className="btn-default btn-link-primary float-right"
              onClick={() => onHighlight()}
            >
              <img src="/assets/images/icon-star-red.svg" /> Destacar
             </Button>)}
