...
const UserSideBar = ({ history, location }) => (
  <Col md="12" className="d-flex flex-column" >
    ...
    <Button style={{ cursor: 'pointer' }} color="default" className={location.pathname === '/userPublications' ? 'active' : ''} onClick={() => history.push('/userPublications?page=1')} >Tus publicaciones</Button>
