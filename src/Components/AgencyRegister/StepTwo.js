      ...
      <div>
        ...
        <Row>
          ...
          <Col md="4">
            ...
            <div>
              <div className="underline" />
              <Button color="secondary" onClick={() => this.props.history.push('/agencyRegisterS1')}>Volver</Button>
              <Button color="primary" onClick={() => this.props.history.push('/agencyRegisterS3')}>Siguiente</Button>
            </div>
          </Col>
        </Row>
