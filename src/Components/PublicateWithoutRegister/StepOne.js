        ...
        <Col md="6" sm="12" xs="12" className="mb-4">
          <div className="col-md-9 float-left">
            ...
            <div>
              ...
              <Button color="default" className="float-left" href="/publicateWithoutRegister">Volver</Button>
              <Button color="primary" className="float-right" href="/publicateWithoutRegisterS2" >Siguiente</Button>
            </div>
          </div>
        </Col>
      </Row>
